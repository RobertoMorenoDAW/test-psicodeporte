...
const BBDD_PREGUNTAS = [
    ...
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Las dos grandes fuentes que principalmente nutren al nivel de activación son el estrés y la motivación.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Cuando la competición siguiente está próxima, la evaluación post-competición debe contemplar únicamente los recursos que el deportista no domina.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Durante los periodos de pausa en las competiciones, resulta innecesario condicionar las técnicas psicológicas a estímulos antecedentes discriminativos.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En una primera fase, el proceso de búsqueda de interpretaciones, expectativas y creencias alternativas se desarrolla en la conversación entre el deportista y el psicólogo mediante preguntas abiertas.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En el periodo previo a la competición, el análisis detallado de las dificultades que el deportista se podría encontrar puede aumentar la inseguridad y ansiedad del deportista en detrimento de su rendimiento.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Las sesiones específicas de práctica en imaginación no pueden ser largas.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En general, cuando se combinan dos o más técnicas de relajación en situaciones estresantes que exigen un afrontamiento inmediato, es aconsejable utilizar los ejercicios de respiración en primer lugar.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "El carácter positivo o negativo de la activación se observa, fundamentalmente, a través de las manifestaciones cognitivas.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En cada uno de los check-points antes de la competición el deportista debe tener en cuenta cuál debería ser su nivel de activación óptimo en ese punto de control para poder llegar en el nivel apropiado cuando la competición comience.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En general, en una competición deportiva, la situación es más estresante cuanto más incierto es el resultado y menor el tiempo que resta para terminar.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Una de las causas por las que se pueden producir efectos paradójicos de la relajación es que algunos deportistas tienen miedo a perder el control.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Los modelos expertos favorecen que los deportistas motivados gracias a los modelos competentes tengan la oportunidad de imitar a modelos más asequibles que estos.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Los estímulos antecedentes variables son los que conforman la situación en la que procede tomar una decisión.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En la evaluación del alto rendimiento lo apropiado es evaluar las decisiones de los deportistas según sea el resultado de su ejecución.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "Lo que se pretende con las situaciones análogas es que el deportista se exponga y ensaye determinadas habilidades repetidamente en presencia de condiciones concretas estresantes, pero estando ausentes otros elementos que están presentes en las competiciones.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Junio 2024 Modelo A",
        pregunta: "En el transcurso de la competición, el deportista utiliza técnicas atencionales de “atención-atención” cuando dirige su atención intensamente a sensaciones de dolor en diferentes partes del cuerpo.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "Las dos grandes fuentes que principalmente nutren al nivel de activación son la motivación y la cohesión de equipo.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "Durante los periodos de pausa en las competiciones, lo que procede son programas de intervención que incluyan, entre otros elementos, elaborar planes de actuación (rutinas) y ensayarlos con antelación en imaginación o en vivo.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "En una primera fase, el proceso de búsqueda de interpretaciones, expectativas y creencias alternativas se desarrolla en la conversación entre el deportista y el psicólogo mediante explicaciones y consejos de este último.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "En deportes de interacción con compañeros y/o adversarios, al elaborar los planes atencionales para una competición suelen ser más apropiados los estímulos internos.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "Para calcular la tendencia colectiva del estado psicológico de un equipo mediante el instrumento TEP, se eliminan las puntuaciones extremas y se tienen en cuenta las puntuaciones más cercanas a la media.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "La combinación de objetivos de resultado, evaluación del rendimiento y premios y penalizaciones vinculados a esos objetivos permite incrementar la eficacia de los ejercicios para el aprendizaje de habilidades técnicas.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "En el desánimo, la falta de interés es la causa, mientras que en la ausencia de motivación la falta de interés es la consecuencia.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "Algunos deportistas prefieren tener una idea aproximada pero no demasiado concreta de sus objetivos de resultado cuando estos están lejos.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "El POMS es un instrumento para evaluar variables psicológicas de rasgo relacionadas con el rendimiento.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "Cuando pueda haber objetivos de evitación, es conveniente transformarlos en objetivos de consecución.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "El entrenador puede aumentar o disminuir la carga psicológica en el entrenamiento manipulando la motivación, el estrés y/o la atención de los deportistas.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "En general, en los deportes de equipo de alto rendimiento suele ser más apropiado que el psicólogo se sitúe más cerca de los jugadores que del entrenador.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "Cuando la motivación es alta pero no va acompañada de una autoconfianza alta, lo más habitual es que se transforme en estrés.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Septiembre 2024 Modelo A",
        pregunta: "En deportes como el tenis, el “miedo a ganar” se produce cuando el deportista está cerca de ganar el partido y aumenta su ansiedad.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo A",
        pregunta: "Las dos grandes fuentes que principalmente nutren al nivel de activación son el estrés y la motivación.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    ...
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "Las dos grandes fuentes que principalmente nutren al nivel de activación son el estrés y la autoconfianza.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "Cuando la competición siguiente está próxima, la evaluación post-competición debe contemplar únicamente los recursos que el deportista domina y evitar destacar los que no domina.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "En el periodo previo a la competición, el análisis detallado de las dificultades que el deportista se podría encontrar, sobre todo cuando se trata de dificultades relacionadas con el propio funcionamiento, puede aumentar la inseguridad y ansiedad del deportista en detrimento de su rendimiento.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "En deportes de interacción con compañeros y/o adversarios, al elaborar los planes atencionales para una competición suelen ser más apropiados los estímulos internos para evitar así distracciones y favorecer una mejor concentración.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "Siempre que se disponga de tiempo, las sesiones de práctica en imaginación deben ser lo suficientemente extensas como para que el deportista pueda visualizar toda la competición.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "Cuando se combinan dos o más técnicas de relajación en situaciones estresantes que exigen un afrontamiento inmediato, es aconsejable utilizar los ejercicios de respiración después que las otras técnicas.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "En su estudio pionero de los psicólogos que trabajaron con deportistas que participaron en los Juegos Olímpicos de 1984, Orlick y Partington encontraron que los psicólogos que fueron valorados negativamente, entre otras características, dedicaron más tiempo al trabajo en grupo con talleres, etc. que a las sesiones individuales.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "En el tramo final previo a la competición, los check-points sirven para que el deportista no olvide nada de lo necesario (material, vestimenta, etc.) y así esté más tranquilo.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "En los periodos de participación activa durante la competición, el funcionamiento mental de los deportistas debe ser prácticamente “automático”.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "En la evaluación del rendimiento post-competición, se deben extraer conclusiones constructivas sobre la relación entre rendimiento y resultado tras haber analizado a ambos por separado.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "Los modelos “competentes” son deportistas de prestigio que se caracterizan por sus éxitos y reconocida destreza en las conductas a observar e imitar.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "La práctica en imaginación “a cámara lenta” puede ser apropiada cuando se intenta modificar un gesto técnico.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
    ...
    {
        tema: "Mayo 2023 Modelo C",
        pregunta: "El psicólogo deportivo puede usar grabaciones de video para que el deportista haga autoobservación objetiva.",
        opciones: ["Verdadero", "Falso"],
        correcta: 0
    },
    {
